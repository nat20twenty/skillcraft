...
public class SkillCraftPerk {
    ...
    public SkillCraftPerk(String skillIdentifier, String skillName, int skillMax, String skillDescription, Identifier iconPath, Identifier backgroundPath, Vector2i skillPosition) {
    ...
    public String getSkillIdentifier() {return this.skillIdentifier;}
